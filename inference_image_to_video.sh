...
python tests/inference.py \
    ...
    --model_path /aifs4su/mmcode/lipeng/cogvideo/ckpts/8000_img_cfg_cogvideox-sft__optimizer_adamw__steps_2000__lr-schedule_cosine_with_restarts__learning-rate_1e-4/checkpoint-2000 \
