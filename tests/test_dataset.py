...
def test_video_dataset():
    from training.dataset import VideoDataset
...
def test_video_dataset_with_resizing():
    from training.dataset import VideoDatasetWithResizing
...
def test_video_dataset_with_bucket_sampler():
    import torch
    from training.dataset import BucketSampler, VideoDatasetWithResizing
